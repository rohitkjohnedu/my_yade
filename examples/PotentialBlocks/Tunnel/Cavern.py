...
p.neverErase = False 
p.filenameOpening = './joints/circleCavern.csv'   # update this to appropriate folder
p.filenameProbabilistic ='./joints/G3joints155_75_25A.csv'  # update this to appropriate folder
...
O.engines = O.engines + [PotentialBlockVTKRecorderTunnel(fileName='./vtk/Tunnel',iterPeriod=5000,sampleX=40,sampleY=1,sampleZ=40,maxDimension=0.05,twoDimension=True,REC_INTERACTION=True,REC_VELOCITY=True, label='vtkRecorderTunnel')]
#O.engines = O.engines + [PotentialBlockVTKRecorder(fileName='./vtk/TunnelClump',iterPeriod=1,sampleX=40,sampleY=1,sampleZ=40,maxDimension=0.05,twoDimension=True,label='vtkRecorder' )]
...
O.engines = O.engines[:3]+  [RockBolt(fileName='./vtk/Tunnel',name='Minus22_5',iterPeriod=1, vtkIteratorInterval=5000,startingPoint = Vector3(0,0,0), boltLength= radius+boltLen, boltDirection=Vector3(-0.9239,0,0.3827), normalStiffness=Kaxial, shearStiffness=Kshear, preTension=tension, axialMax=Pult,shearMax=Sult,openingRad=openingRadius,halfActiveLength=boltDiameter,axialStiffness=EAbolt,useMidPoint=smoothOut,label='boltMinus225' )] + O.engines[3:]
O.engines = O.engines[:3]+  [RockBolt(fileName='./vtk/Tunnel',name='Minus11_25',iterPeriod=1, vtkIteratorInterval=5000,startingPoint = Vector3(0,0,0), boltLength= radius+boltLen, boltDirection=Vector3(-0.9808,0,0.1951), normalStiffness=Kaxial, shearStiffness=Kshear, preTension=tension,axialMax=Pult,shearMax=Sult,openingRad=openingRadius,halfActiveLength=boltDiameter,axialStiffness=EAbolt,useMidPoint=smoothOut, label='boltMinus11_25' )] + O.engines[3:]
O.engines = O.engines[:3]+  [RockBolt(fileName='./vtk/Tunnel',name='0',iterPeriod=1, vtkIteratorInterval=5000,startingPoint = Vector3(0,0,0), boltLength= radius+boltLen, boltDirection=Vector3(-1,0,-0.0), normalStiffness=Kaxial, shearStiffness=Kshear,preTension =tension, axialMax=Pult,shearMax=Sult, openingRad=openingRadius,halfActiveLength=boltDiameter,axialStiffness=EAbolt,useMidPoint=smoothOut, label='bolt0' )] + O.engines[3:]
...
O.engines = O.engines[:3]+  [RockBolt(fileName='./vtk/Tunnel',name='22_5',iterPeriod=1, vtkIteratorInterval=5000,startingPoint = Vector3(0,0,0), boltLength= radius+boltLen, boltDirection=Vector3(-0.9239,0.0,-0.3827), normalStiffness=Kaxial, shearStiffness=Kshear,axialMax=Pult,shearMax=Sult, preTension=tension, openingRad=openingRadius,halfActiveLength=boltDiameter,axialStiffness=EAbolt,useMidPoint=smoothOut,label='bolt225' )] + O.engines[3:]
O.engines = O.engines[:3]+  [RockBolt(fileName='./vtk/Tunnel',name='33_75',iterPeriod=1, vtkIteratorInterval=5000,startingPoint = Vector3(0,0,0), boltLength= radius+boltLen, boltDirection=Vector3(-0.8315,0,-0.5556), normalStiffness=Kaxial, shearStiffness=Kshear, axialMax=Pult,shearMax=Sult,preTension=tension,openingRad=openingRadius, halfActiveLength=boltDiameter,axialStiffness=EAbolt,useMidPoint=smoothOut,label='bolt33_75' )] + O.engines[3:]
O.engines = O.engines[:3]+  [RockBolt(fileName='./vtk/Tunnel',name='45',iterPeriod=1, vtkIteratorInterval=5000,startingPoint = Vector3(0,0,0), boltLength= radius+boltLen, boltDirection=Vector3(-0.7071,0.0,-0.7071), normalStiffness=Kaxial, shearStiffness=Kshear, axialMax=Pult,shearMax=Sult,preTension=tension ,openingRad=openingRadius, halfActiveLength=boltDiameter,axialStiffness=EAbolt,useMidPoint=smoothOut,label='bolt45')] + O.engines[3:]
O.engines = O.engines[:3]+  [RockBolt(fileName='./vtk/Tunnel',name='56_25',iterPeriod=1, vtkIteratorInterval=5000,startingPoint = Vector3(0,0,0), boltLength= radius+boltLen, boltDirection=Vector3(-0.5556,0,-0.8315), normalStiffness=Kaxial, shearStiffness=Kshear, axialMax=Pult,shearMax=Sult,preTension=tension,openingRad=openingRadius, halfActiveLength=boltDiameter,axialStiffness=EAbolt,useMidPoint=smoothOut,label='bolt56_25' )] + O.engines[3:]
O.engines = O.engines[:3]+  [RockBolt(fileName='./vtk/Tunnel',name='67_5',iterPeriod=1, vtkIteratorInterval=5000,startingPoint = Vector3(0,0,0), boltLength= radius+boltLen, boltDirection=Vector3(-0.3827,0.0,-0.9239), normalStiffness=Kaxial, shearStiffness=Kshear, axialMax=Pult,shearMax=Sult,preTension=tension ,openingRad=openingRadius, halfActiveLength=boltDiameter,axialStiffness=EAbolt,useMidPoint=smoothOut,label='bolt675')] + O.engines[3:]
O.engines = O.engines[:3]+  [RockBolt(fileName='./vtk/Tunnel',name='78_75',iterPeriod=1, vtkIteratorInterval=5000,startingPoint = Vector3(0,0,0), boltLength= radius+boltLen, boltDirection=Vector3(-0.1951,0,-0.9808),normalStiffness=Kaxial, shearStiffness=Kshear, axialMax=Pult,shearMax=Sult,preTension=tension, openingRad=openingRadius,halfActiveLength=boltDiameter,axialStiffness=EAbolt,useMidPoint=smoothOut,label='bolt78_75' )] + O.engines[3:]
O.engines = O.engines[:3]+  [RockBolt(fileName='./vtk/Tunnel',name='90',iterPeriod=1, vtkIteratorInterval=5000,startingPoint = Vector3(0,0,0), boltLength= radius+boltLen, boltDirection=Vector3(0,0,-1.0), normalStiffness=Kaxial, shearStiffness=Kshear, axialMax=Pult,shearMax=Sult,preTension=tension,openingRad=openingRadius, halfActiveLength=boltDiameter,axialStiffness=EAbolt,useMidPoint=smoothOut,label='bolt90' )] + O.engines[3:]
O.engines = O.engines[:3]+  [RockBolt(fileName='./vtk/Tunnel',name='101_25',iterPeriod=1, vtkIteratorInterval=5000,startingPoint = Vector3(0,0,0), boltLength= radius+boltLen, boltDirection=Vector3(0.1951,0,-0.9808), normalStiffness=Kaxial, shearStiffness=Kshear,axialMax=Pult,shearMax=Sult,preTension=tension,openingRad=openingRadius, halfActiveLength=boltDiameter,axialStiffness=EAbolt,useMidPoint=smoothOut,label='bolt101_25' )] + O.engines[3:]
O.engines = O.engines[:3]+  [RockBolt(fileName='./vtk/Tunnel',name='112_5',iterPeriod=1, vtkIteratorInterval=5000,startingPoint = Vector3(0,0,0), boltLength= radius+boltLen, boltDirection=Vector3(0.3827,0,-0.9239), normalStiffness=Kaxial, shearStiffness=Kshear, axialMax=Pult,shearMax=Sult,preTension=tension,openingRad=openingRadius, halfActiveLength=boltDiameter,axialStiffness=EAbolt,useMidPoint=smoothOut,label='bolt113' )] + O.engines[3:]
O.engines = O.engines[:3]+  [RockBolt(fileName='./vtk/Tunnel',name='123_75',iterPeriod=1, vtkIteratorInterval=5000,startingPoint = Vector3(0,0,0), boltLength= radius+boltLen, boltDirection=Vector3(0.5556,0,-0.8315), normalStiffness=Kaxial, shearStiffness=Kshear, axialMax=Pult,shearMax=Sult,preTension=tension,openingRad=openingRadius, halfActiveLength=boltDiameter,axialStiffness=EAbolt,useMidPoint=smoothOut,label='bolt123_75' )] + O.engines[3:]
O.engines = O.engines[:3]+  [RockBolt(fileName='./vtk/Tunnel',name='135',iterPeriod=1, vtkIteratorInterval=5000,startingPoint = Vector3(0,0,0), boltLength= radius+boltLen, boltDirection=Vector3(0.7071,0,-0.7071), normalStiffness=Kaxial, shearStiffness=Kshear, axialMax=Pult,shearMax=Sult,preTension=tension,openingRad=openingRadius, halfActiveLength=boltDiameter,axialStiffness=EAbolt,useMidPoint=smoothOut,label='bolt135' )] + O.engines[3:]
O.engines = O.engines[:3]+  [RockBolt(fileName='./vtk/Tunnel',name='146_25',iterPeriod=1, vtkIteratorInterval=5000,startingPoint = Vector3(0,0,0), boltLength= radius+boltLen, boltDirection=Vector3(0.8315,0,-0.5556), normalStiffness=Kaxial, shearStiffness=Kshear, axialMax=Pult,shearMax=Sult,preTension=tension,openingRad=openingRadius, halfActiveLength=boltDiameter,axialStiffness=EAbolt,useMidPoint=smoothOut,label='bolt146_25' )] + O.engines[3:]
O.engines = O.engines[:3]+  [RockBolt(fileName='./vtk/Tunnel',name='157_5',iterPeriod=1, vtkIteratorInterval=5000,startingPoint = Vector3(0,0,0), boltLength= radius+boltLen, boltDirection=Vector3(0.9239,0,-0.3827), normalStiffness=Kaxial, shearStiffness=Kshear, axialMax=Pult,shearMax=Sult,preTension=tension,openingRad=openingRadius, halfActiveLength=boltDiameter,axialStiffness=EAbolt,useMidPoint=smoothOut,label='bolt158' )] + O.engines[3:]
O.engines = O.engines[:3]+  [RockBolt(fileName='./vtk/Tunnel',name='168_75',iterPeriod=1, vtkIteratorInterval=5000,startingPoint = Vector3(0,0,0), boltLength= radius+boltLen, boltDirection=Vector3(0.9808,0,-0.1951), normalStiffness=Kaxial, shearStiffness=Kshear, axialMax=Pult,shearMax=Sult,preTension=tension,openingRad=openingRadius, halfActiveLength=boltDiameter,axialStiffness=EAbolt,useMidPoint=smoothOut,label='bolt168_75' )] + O.engines[3:]
O.engines = O.engines[:3]+  [RockBolt(fileName='./vtk/Tunnel',name='180',iterPeriod=1, vtkIteratorInterval=5000,startingPoint = Vector3(0,0,0), boltLength= radius+boltLen, boltDirection=Vector3(1,0,0.0), normalStiffness=Kaxial, shearStiffness=Kshear,axialMax=Pult,shearMax=Sult, preTension=tension, openingRad=openingRadius,halfActiveLength=boltDiameter,axialStiffness=EAbolt,useMidPoint=smoothOut,label='bolt180' )] + O.engines[3:]
O.engines = O.engines[:3]+  [RockBolt(fileName='./vtk/Tunnel',name='191_25',iterPeriod=1, vtkIteratorInterval=5000,startingPoint = Vector3(0,0,0), boltLength= radius+boltLen, boltDirection=Vector3(0.9808,0,0.1951), normalStiffness=Kaxial, shearStiffness=Kshear, axialMax=Pult,shearMax=Sult,preTension=tension,openingRad=openingRadius, halfActiveLength=boltDiameter,axialStiffness=EAbolt,useMidPoint=smoothOut,label='bolt191_25' )] + O.engines[3:]
O.engines = O.engines[:3]+  [RockBolt(fileName='./vtk/Tunnel',name='202_5',iterPeriod=1, vtkIteratorInterval=5000,startingPoint = Vector3(0,0,0), boltLength= radius+boltLen, boltDirection=Vector3(0.9239,0.0,0.3827), normalStiffness=Kaxial, shearStiffness=Kshear,axialMax=Pult,shearMax=Sult,preTension=tension, openingRad=openingRadius,halfActiveLength=boltDiameter,axialStiffness=EAbolt,useMidPoint=smoothOut,label='bolt2025' )] + O.engines[3:]
...
O.engines = O.engines[:3]+  [RockBolt(fileName='./vtk/Tunnel',name='L2',iterPeriod=1, vtkIteratorInterval=5000,startingPoint = Vector3(0,0,0), boltLength= radius+boltLen, boltDirection=Vector3(-0.2924,0,-0.9563), normalStiffness=Kaxial, shearStiffness=Kshear, axialMax=Pult,shearMax=Sult,preTension=tension,openingRad=openingRadius, halfActiveLength=boltDiameter,axialStiffness=EAbolt,useMidPoint=smoothOut,label='boltL2' )] + O.engines[3:]

O.engines = O.engines[:3]+  [RockBolt(fileName='./vtk/Tunnel',name='R1',iterPeriod=1, vtkIteratorInterval=5000,startingPoint = Vector3(0,0,0), boltLength= radius+boltLen, boltDirection=Vector3(0.08716,0,-0.9962), normalStiffness=Kaxial, shearStiffness=Kshear,axialMax=Pult,shearMax=Sult, preTension=tension, openingRad=openingRadius,halfActiveLength=boltDiameter,axialStiffness=EAbolt,useMidPoint=smoothOut ,label='boltR1' )] + O.engines[3:]
O.engines = O.engines[:3]+  [RockBolt(fileName='./vtk/Tunnel',name='R2',iterPeriod=1, vtkIteratorInterval=5000,startingPoint = Vector3(0,0,0), boltLength= radius+boltLen, boltDirection=Vector3(0.2924,0,-0.9563), normalStiffness=Kaxial, shearStiffness=Kshear, axialMax=Pult,shearMax=Sult,preTension=tension,openingRad=openingRadius, halfActiveLength=boltDiameter,axialStiffness=EAbolt,useMidPoint=smoothOut,label='boltR2' )] + O.engines[3:]


O.engines = O.engines[:3]+  [RockBolt(fileName='./vtk/Tunnel',name='15',iterPeriod=1, vtkIteratorInterval=5000,startingPoint = Vector3(0,0,0), boltLength= radius+boltLen, boltDirection=Vector3(-0.96593,0,-0.25882), normalStiffness=Kaxial, shearStiffness=Kshear,axialMax=Pult,shearMax=Sult,preTension=tension,openingRad=openingRadius, halfActiveLength=boltDiameter,axialStiffness=EAbolt,useMidPoint=smoothOut,label='bolt15' )] + O.engines[3:]
O.engines = O.engines[:3]+  [RockBolt(fileName='./vtk/Tunnel',name='30',iterPeriod=1, vtkIteratorInterval=5000,startingPoint = Vector3(0,0,0), boltLength= radius+boltLen, boltDirection=Vector3(-0.866,0,-0.5), normalStiffness=Kaxial, shearStiffness=Kshear, axialMax=Pult,shearMax=Sult,preTension=tension,openingRad=openingRadius, halfActiveLength=boltDiameter,axialStiffness=EAbolt,useMidPoint=smoothOut,label='bolt30' )] + O.engines[3:]
O.engines = O.engines[:3]+  [RockBolt(fileName='./vtk/Tunnel',name='60',iterPeriod=1, vtkIteratorInterval=5000,startingPoint = Vector3(0,0,0), boltLength= radius+boltLen, boltDirection=Vector3(-0.5,0,-0.866), normalStiffness=Kaxial, shearStiffness=Kshear, axialMax=Pult,shearMax=Sult,preTension=tension,openingRad=openingRadius, halfActiveLength=boltDiameter,axialStiffness=EAbolt,useMidPoint=smoothOut,label='bolt60' )] + O.engines[3:]
O.engines = O.engines[:3]+  [RockBolt(fileName='./vtk/Tunnel',name='75',iterPeriod=1, vtkIteratorInterval=5000,startingPoint = Vector3(0,0,0), boltLength= radius+boltLen, boltDirection=Vector3(-0.2588,0,-0.96593), normalStiffness=Kaxial, shearStiffness=Kshear, axialMax=Pult,shearMax=Sult,preTension=tension,openingRad=openingRadius, halfActiveLength=boltDiameter,axialStiffness=EAbolt,useMidPoint=smoothOut,label='bolt75' )] + O.engines[3:]
O.engines = O.engines[:3]+  [RockBolt(fileName='./vtk/Tunnel',name='105',iterPeriod=1, vtkIteratorInterval=5000,startingPoint = Vector3(0,0,0), boltLength= radius+boltLen, boltDirection=Vector3(0.2588,0,-0.96593), normalStiffness=Kaxial, shearStiffness=Kshear, axialMax=Pult,shearMax=Sult,preTension=tension,openingRad=openingRadius, halfActiveLength=boltDiameter,axialStiffness=EAbolt,useMidPoint=smoothOut,label='bolt105' )] + O.engines[3:]
O.engines = O.engines[:3]+  [RockBolt(fileName='./vtk/Tunnel',name='120',iterPeriod=1, vtkIteratorInterval=5000,startingPoint = Vector3(0,0,0), boltLength= radius+boltLen, boltDirection=Vector3(0.5,0,-0.866), normalStiffness=Kaxial, shearStiffness=Kshear, axialMax=Pult,shearMax=Sult,preTension=tension,openingRad=openingRadius, halfActiveLength=boltDiameter,axialStiffness=EAbolt,useMidPoint=smoothOut,label='bolt120' )] + O.engines[3:]
O.engines = O.engines[:3]+  [RockBolt(fileName='./vtk/Tunnel',name='150',iterPeriod=1, vtkIteratorInterval=5000,startingPoint = Vector3(0,0,0), boltLength= radius+boltLen, boltDirection=Vector3(0.866,0,-0.5), normalStiffness=Kaxial, shearStiffness=Kshear, axialMax=Pult,shearMax=Sult,preTension=tension,openingRad=openingRadius, halfActiveLength=boltDiameter,axialStiffness=EAbolt,useMidPoint=smoothOut,label='bolt150' )] + O.engines[3:]
O.engines = O.engines[:3]+  [RockBolt(fileName='./vtk/Tunnel',name='165',iterPeriod=1, vtkIteratorInterval=5000,startingPoint = Vector3(0,0,0), boltLength= radius+boltLen, boltDirection=Vector3(0.96593,0,-0.25882), normalStiffness=Kaxial, shearStiffness=Kshear,axialMax=Pult,shearMax=Sult, preTension=tension, openingRad=openingRadius,halfActiveLength=boltDiameter,axialStiffness=EAbolt,useMidPoint=smoothOut,label='bolt165' )] + O.engines[3:]

O.engines = O.engines[:3]+  [RockBolt(fileName='./vtk/Tunnel',name='5',iterPeriod=1,
...
O.engines = O.engines[:3]+  [RockBolt(fileName='./vtk/Tunnel',name='10',iterPeriod=1,
...
O.engines = O.engines[:3]+  [RockBolt(fileName='./vtk/Tunnel',name='20',iterPeriod=1,
...
O.engines = O.engines[:3]+  [RockBolt(fileName='./vtk/Tunnel',name='25',iterPeriod=1,
...
O.engines = O.engines[:3]+  [RockBolt(fileName='./vtk/Tunnel',name='35',iterPeriod=1,
...
O.engines = O.engines[:3]+  [RockBolt(fileName='./vtk/Tunnel',name='40',iterPeriod=1,
...
O.engines = O.engines[:3]+  [RockBolt(fileName='./vtk/Tunnel',name='50',iterPeriod=1,
...
O.engines = O.engines[:3]+  [RockBolt(fileName='./vtk/Tunnel',name='55',iterPeriod=1,
...
O.engines = O.engines[:3]+  [RockBolt(fileName='./vtk/Tunnel',name='65',iterPeriod=1,
...
O.engines = O.engines[:3]+  [RockBolt(fileName='./vtk/Tunnel',name='70',iterPeriod=1,
...
O.engines = O.engines[:3]+  [RockBolt(fileName='./vtk/Tunnel',name='80',iterPeriod=1,
...
O.engines = O.engines[:3]+  [RockBolt(fileName='./vtk/Tunnel',name='85',iterPeriod=1,
...
O.engines = O.engines[:3]+  [RockBolt(fileName='./vtk/Tunnel',name='95',iterPeriod=1,
...
O.engines = O.engines[:3]+  [RockBolt(fileName='./vtk/Tunnel',name='100',iterPeriod=1,
...
O.engines = O.engines[:3]+  [RockBolt(fileName='./vtk/Tunnel',name='110',iterPeriod=1,
...
O.engines = O.engines[:3]+  [RockBolt(fileName='./vtk/Tunnel',name='115',iterPeriod=1,
...
O.engines = O.engines[:3]+  [RockBolt(fileName='./vtk/Tunnel',name='125',iterPeriod=1,
...
O.engines = O.engines[:3]+  [RockBolt(fileName='./vtk/Tunnel',name='130',iterPeriod=1,
...
O.engines = O.engines[:3]+  [RockBolt(fileName='./vtk/Tunnel',name='140',iterPeriod=1,
...
O.engines = O.engines[:3]+  [RockBolt(fileName='./vtk/Tunnel',name='145',iterPeriod=1,
...
O.engines = O.engines[:3]+  [RockBolt(fileName='./vtk/Tunnel',name='155',iterPeriod=1,
...
O.engines = O.engines[:3]+  [RockBolt(fileName='./vtk/Tunnel',name='160',iterPeriod=1,
...
O.engines = O.engines[:3]+  [RockBolt(fileName='./vtk/Tunnel',name='170',iterPeriod=1,
...
O.engines = O.engines[:3]+  [RockBolt(fileName='./vtk/Tunnel',name='175',iterPeriod=1,
...
O.engines = O.engines[:3]+  [RockBolt(fileName='./vtk/Tunnel',name='m5',iterPeriod=1,
...
O.engines = O.engines[:3]+  [RockBolt(fileName='./vtk/Tunnel',name='m10',iterPeriod=1,
...
O.engines = O.engines[:3]+  [RockBolt(fileName='./vtk/Tunnel',name='m15',iterPeriod=1, vtkIteratorInterval=5000,startingPoint = Vector3(0,0,0), boltLength= radius+boltLen, boltDirection=Vector3(-0.96593,0,0.25882), normalStiffness=Kaxial, shearStiffness=Kshear,axialMax=Pult,shearMax=Sult,preTension=tension,openingRad=openingRadius, halfActiveLength=boltDiameter,axialStiffness=EAbolt,useMidPoint=smoothOut,label='boltm15' )] + O.engines[3:]
O.engines = O.engines[:3]+  [RockBolt(fileName='./vtk/Tunnel',name='mEast5',iterPeriod=1,
...
O.engines = O.engines[:3]+  [RockBolt(fileName='./vtk/Tunnel',name='mEast10',iterPeriod=1,
...
O.engines = O.engines[:3]+  [RockBolt(fileName='./vtk/Tunnel',name='m7_5',iterPeriod=1,
...
O.engines = O.engines[:3]+  [RockBolt(fileName='./vtk/Tunnel',name='m2_5',iterPeriod=1,
...
O.engines = O.engines[:3]+  [RockBolt(fileName='./vtk/Tunnel',name='2_5',iterPeriod=1,
...
O.engines = O.engines[:3]+  [RockBolt(fileName='./vtk/Tunnel',name='7_5',iterPeriod=1,
...
O.engines = O.engines[:3]+  [RockBolt(fileName='./vtk/Tunnel',name='12_5',iterPeriod=1,
...
O.engines = O.engines[:3]+  [RockBolt(fileName='./vtk/Tunnel',name='17_5',iterPeriod=1,
...
O.engines = O.engines[:3]+  [RockBolt(fileName='./vtk/Tunnel',name='27_5',iterPeriod=1,
...
O.engines = O.engines[:3]+  [RockBolt(fileName='./vtk/Tunnel',name='32_5',iterPeriod=1,
...
O.engines = O.engines[:3]+  [RockBolt(fileName='./vtk/Tunnel',name='37_5',iterPeriod=1,
...
O.engines = O.engines[:3]+  [RockBolt(fileName='./vtk/Tunnel',name='42_5',iterPeriod=1,
...
O.engines = O.engines[:3]+  [RockBolt(fileName='./vtk/Tunnel',name='47_5',iterPeriod=1,
...
O.engines = O.engines[:3]+  [RockBolt(fileName='./vtk/Tunnel',name='52_5',iterPeriod=1,
...
O.engines = O.engines[:3]+  [RockBolt(fileName='./vtk/Tunnel',name='57_5',iterPeriod=1,
...
O.engines = O.engines[:3]+  [RockBolt(fileName='./vtk/Tunnel',name='62_5',iterPeriod=1,
...
O.engines = O.engines[:3]+  [RockBolt(fileName='./vtk/Tunnel',name='72_5',iterPeriod=1,
...
O.engines = O.engines[:3]+  [RockBolt(fileName='./vtk/Tunnel',name='77_5',iterPeriod=1,
...
O.engines = O.engines[:3]+  [RockBolt(fileName='./vtk/Tunnel',name='82_5',iterPeriod=1,
...
O.engines = O.engines[:3]+  [RockBolt(fileName='./vtk/Tunnel',name='87_5',iterPeriod=1,
...
O.engines = O.engines[:3]+  [RockBolt(fileName='./vtk/Tunnel',name='92_5',iterPeriod=1,
...
O.engines = O.engines[:3]+  [RockBolt(fileName='./vtk/Tunnel',name='97_5',iterPeriod=1,
...
O.engines = O.engines[:3]+  [RockBolt(fileName='./vtk/Tunnel',name='102_5',iterPeriod=1,
...
O.engines = O.engines[:3]+  [RockBolt(fileName='./vtk/Tunnel',name='107_5',iterPeriod=1,
...
O.engines = O.engines[:3]+  [RockBolt(fileName='./vtk/Tunnel',name='117_5',iterPeriod=1,
...
O.engines = O.engines[:3]+  [RockBolt(fileName='./vtk/Tunnel',name='122_5',iterPeriod=1,
...
O.engines = O.engines[:3]+  [RockBolt(fileName='./vtk/Tunnel',name='127_5',iterPeriod=1,
...
O.engines = O.engines[:3]+  [RockBolt(fileName='./vtk/Tunnel',name='132_5',iterPeriod=1,
...
O.engines = O.engines[:3]+  [RockBolt(fileName='./vtk/Tunnel',name='137_5',iterPeriod=1,
...
O.engines = O.engines[:3]+  [RockBolt(fileName='./vtk/Tunnel',name='142_5',iterPeriod=1,
...
O.engines = O.engines[:3]+  [RockBolt(fileName='./vtk/Tunnel',name='147_5',iterPeriod=1,
...
O.engines = O.engines[:3]+  [RockBolt(fileName='./vtk/Tunnel',name='152_5',iterPeriod=1,
...
O.engines = O.engines[:3]+  [RockBolt(fileName='./vtk/Tunnel',name='162_5',iterPeriod=1,
...
O.engines = O.engines[:3]+  [RockBolt(fileName='./vtk/Tunnel',name='167_5',iterPeriod=1,
...
O.engines = O.engines[:3]+  [RockBolt(fileName='./vtk/Tunnel',name='172_5',iterPeriod=1,
...
O.engines = O.engines[:3]+  [RockBolt(fileName='./vtk/Tunnel',name='177_5',iterPeriod=1,
...
O.engines = O.engines[:3]+  [RockBolt(fileName='./vtk/Tunnel',name='182_5',iterPeriod=1,
...
O.engines = O.engines[:3]+  [RockBolt(fileName='./vtk/Tunnel',name='187_5',iterPeriod=1,
...
O.engines = O.engines[:3]+  [RockBolt(fileName='./vtk/Tunnel',name='192_5',iterPeriod=1,
...
#Cavern
O.engines = O.engines[:3]+  [RockBolt(fileName='./vtk/Tunnel',name='hori+1m',iterPeriod=1,
...
O.engines = O.engines[:3]+  [RockBolt(fileName='./vtk/Tunnel',name='hori+2m',iterPeriod=1,
...
O.engines = O.engines[:3]+  [RockBolt(fileName='./vtk/Tunnel',name='hori+3m',iterPeriod=1,
...
O.engines = O.engines[:3]+  [RockBolt(fileName='./vtk/Tunnel',name='hori+4m',iterPeriod=1,
...
O.engines = O.engines[:3]+  [RockBolt(fileName='./vtk/Tunnel',name='hori+5m',iterPeriod=1,
...
O.engines = O.engines[:3]+  [RockBolt(fileName='./vtk/Tunnel',name='hori+6m',iterPeriod=1,
...
O.engines = O.engines[:3]+  [RockBolt(fileName='./vtk/Tunnel',name='hori+7m',iterPeriod=1,
...
O.engines = O.engines[:3]+  [RockBolt(fileName='./vtk/Tunnel',name='hori+8m',iterPeriod=1,
...
O.engines = O.engines[:3]+  [RockBolt(fileName='./vtk/Tunnel',name='hori+9m',iterPeriod=1,
...
f.write('bolt0f\tbolt0axial\tbolt0shear\truptured\tnodePosFrCentre\n')
f.close()
f = open('./vtk/hori+6m.txt','w')
f.write('bolt0f\tbolt0axial\tbolt0shear\truptured\tnodePosFrCentre\n')
f.close()
f = open('./vtk/hori+7m.txt','w')
f.write('bolt0f\tbolt0axial\tbolt0shear\truptured\tnodePosFrCentre\n')
f.close()
f = open('./vtk/hori+8m.txt','w')
f.write('bolt0f\tbolt0axial\tbolt0shear\truptured\tnodePosFrCentre\n')
f.close()
f = open('./vtk/hori+9m.txt','w')
f.write('bolt0f\tbolt0axial\tbolt0shear\truptured\tnodePosFrCentre\n')
f.close()
f = open('./vtk/hori-6m.txt','w')
f.write('bolt0f\tbolt0axial\tbolt0shear\truptured\tnodePosFrCentre\n')
...
def record(stageNo):
	...
	while count < nodeNo:
		...
		count = count+1
	f.close()
	f = open('./vtk/boltMinus11_25.txt','a')	
	count = 0
